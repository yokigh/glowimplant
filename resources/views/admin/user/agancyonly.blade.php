                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">{{ __('pages.onlyagancy') }}</h4>
                                            <p class="card-title-desc">{{ __('pages.textonlyagancy') }}
                                            </p>
            
                                            <a href="{{ route('createagancyonly.index', ['lang' => app()->getLocale()]) }}">
                                                <button class="btn btn-primary waves-effect waves-light">{{ __('pages.create_agency') }}</button>
                                            </a> 
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'عدد المستخدمين الجدد بدور "agency"',
                    data: userCounts,
                    borderColor: 'blue',
                    borderWidth: 2,
                    fill: false
