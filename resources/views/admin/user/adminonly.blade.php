                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">{{ __('pages.onlyadmin') }}</h4>
                                            <p class="card-title-desc">{{ __('pages.textonlyadmin') }}
                                            </p>
            
                                            <a href="{{ route('createadminonly.index', ['lang' => app()->getLocale()]) }}">
                                                <button class="btn btn-primary waves-effect waves-light">{{ __('pages.create_admin') }}</button>
                                            </a> 
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'عدد المستخدمين الجدد بدور "admin"',
                    data: userCounts,
                    borderColor: 'blue',
                    borderWidth: 2,
                    fill: false
