    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group mb-3 row">
                    <label for="example-text-input" class="col-md-2 col-form-label">{{ __('pages.username') }}</label>
                    <div class="col-md-10">
                ...
                <input type="text" value="agency" name="role" hidden>
                ...
                <button type="submit" class="btn btn-primary waves-effect waves-light">{{ __('pages.create_agency') }}</button>
            </div>
        </div>
    </div>
    <!-- end col -->
