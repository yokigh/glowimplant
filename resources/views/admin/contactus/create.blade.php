...
@section('title', __('pages.Create Contact'))
@section('content')
...
<form action="{{ route('contactus.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data" class="row">
    @csrf
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('pages.Create Contact') }}</h4>
                ...
                @foreach ($languages as $lang)
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="name_{{ $lang }}" value="{{ old('name_'.$lang) }}">
                        </div>
                    </div>
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" name="map" value="{{ old('map') }}">
                    </div>
                </div>
                ...
                @foreach ($socialLinks as $social)
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="url" name="url_{{ $social }}" value="{{ old('url_'.$social) }}">
                        </div>
                    </div>
                @endforeach

                <button type="submit" class="btn btn-primary waves-effect waves-light">{{ __('pages.create_contact') }}</button>
            </div>
        </div>
    </div>
</form>
