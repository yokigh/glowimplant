...
@section('title', 'Create Prostatic Category')
...
<form action="{{ route('prostatic_categories.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data" class="row">
    @csrf
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('pages.create_prostatic_category') }}</h4>
                ...
                <button type="submit" class="btn btn-primary waves-effect waves-light">{{ __('pages.create_prostatic_category') }}</button>
            </div>
        </div>
    </div>
</form>
