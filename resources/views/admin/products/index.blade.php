                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('products.create', ['lang' => app()->getLocale()]) }}">
                                                    ...
                                                    <tr>
                                                      ...
                                                      @endforeach
                                                        ...
                                                        <td>
                                                            ...
                                                            <form id="delete-form-{{ $product->id }}" action="{{ route('products.destroy', ['lang' => app()->getLocale(), 'product' => $product->id]) }}" method="POST" style="display: none;">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
