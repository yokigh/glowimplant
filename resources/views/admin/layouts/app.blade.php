                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{ route('dashboard.admins', ['lang' => app()->getLocale()]) }}" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="{{ route('dashboard.admins', ['lang' => app()->getLocale()]) }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{asset('assets/images/logo/glow.png')}}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ asset('assets/images/admin.png') }}" alt="Header Avatar">
                                <span class="d-none d-sm-inline-block ms-1">{{ auth()->user()->name }}</span>
                                <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end ">
                                <a class="dropdown-item" href="{{route('user.profile', ['lang' => app()->getLocale()])}}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i>{{ __('pages.Profile') }} </a>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('dashboard.admins', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('users.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.alluser') }}</a></li>
                                    <li><a href="{{ route('users.onlyuser', ['lang' => app()->getLocale()]) }}">{{ __('pages.user') }}</a></li>
                                    <li><a href="{{ route('users.onlyadmin', ['lang' => app()->getLocale()]) }}">{{ __('pages.admin') }}</a></li>
                                    <li><a href="{{ route('users.onlyagancy', ['lang' => app()->getLocale()]) }}">{{ __('pages.agancy') }}</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="{{ route('about-us.index', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="uim uim-star-half-alt"></i></div>
                                    <span>{{ __('pages.about-us') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('countries.index', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="fab fa-angellist"></i></div>
                                    <span>{{ __('pages.countries') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('categories.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.cateegory') }}</a></li>
                                    <li><a href="{{ route('subcategories.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.subproduct') }}</a></li>
                                    <li><a href="{{ route('products.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.product') }}</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="fas fa-boxes"></i></div>
                                    <span>{{ __('pages.prosthetic') }}</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('prostatic_categories.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.prostatic_categories') }}</a></li>
                                    <li><a href="{{ route('prosthetic_products.index', ['lang' => app()->getLocale()]) }}">{{ __('pages.prostatic_products') }}</a></li>
                                </ul>
                            </li>
                            
                            <li>
                                <a href="{{ route('events.index', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="fab fa-buromobelexperte"></i></div>
                                    <span>{{ __('pages.event') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('contactus.index', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="fas fa-bullhorn"></i></div>
                                    <span>{{ __('pages.contactus') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('sliders.index', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="uim uim-layer-group"></i></div>
                                    <span>{{ __('pages.sliders') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('index.pay', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                                    <div class="d-inline-block icons-sm me-1"><i class="uim uim-download-alt"></i></div>
