                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">{{ __('pages.subcategories') }}</h4>
                                            <p class="card-title-desc">{{ __('pages.textsubcategories') }}
                                            </p>
                                            <a href="{{ route('subcategories.create', ['lang' => app()->getLocale()]) }}">
                                                <button class="btn btn-primary waves-effect waves-light">{{ __('pages.create_subcategories') }}</button>
                                            </a> 
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $subcategory->category ? $subcategory->category->{'name_' . app()->getLocale()} : '-' }}</td>
                                                    <td> </td>
                                                    <td>
                                                        <!-- show category -->
                                                        <a href="{{ route('subcategories.show', ['lang' => app()->getLocale(), 'subcategory' => $subcategory->id]) }}" 
