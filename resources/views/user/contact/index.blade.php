                ...
                <div class="col-xl-4 col-md-6">
                    <div class="location-card">
                        ...
                        <ul style="list-style-type: none;">
                            <li><a href="{{$firstcontactUs->url_facebook}}"><i class="fab fa-facebook-f"></i></a>  {{ __('messages.facebook') }}</li>
                            <li><a href="{{$firstcontactUs->url_x}}"><i class="fa-brands fa-x-twitter"></i></a>  {{ __('messages.x-twitter') }}</li>
                            <li><a href="{{$firstcontactUs->url_whatsapp}}"><i class="fab fa-whatsapp"></i></a>  {{ __('messages.whatsapp') }}</li>
                            <li><a href="{{$firstcontactUs->url_instagram}}"><i class="fa-brands fa-instagram"></i></a>  {{ __('messages.instagram') }}</li>
                            <li><a href="{{$firstcontactUs->url_tiktok}}"><i class="fa-brands fa-tiktok"></i></a>  {{ __('messages.tiktok') }}</li>
                            <li><a href="{{$firstcontactUs->url_youtube}}"><i class="fab fa-youtube"></i></a>  {{ __('messages.youtube') }}</li>
                        </ul>
        ...
        <div class="container">
            <form action="mail.php" method="POST" class="contact-form ajax-contact" style="display: flex;justify-content: space-around;flex-wrap: wrap;" data-bg-src="{{ asset('user/assets/img/bg.jpg') }}">
                <div class="input-wrap">
                    <h2 class="sec-title">{{ $firstcontactUs->{'name_' . app()->getLocale()} }}</h2>
                    <div class="row">
                ...
                <div class="input-wrap">
                {!! $firstcontactUs->{'description_' . app()->getLocale()} !!}
</div>
            </form>
            <div>
...
==============================-->
    <div class="">
        <div class="contact-map">
            <iframe src="{{$firstcontactUs->map}}" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </div>
